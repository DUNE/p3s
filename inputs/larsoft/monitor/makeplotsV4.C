// makeplotsV4.C
// to execute non-interactively:  root -b -l -q 'makeplotsV4.C("rawtpcmonitor.root");'
// root -b -l -q 'makeplotsV4.C("rawtpcmonitor.root");' > /dev/null 2>&1
...
void makeplotsV4(TString infile="rawtpcmonitor.root"){
